...
SECRET_KEY = 'django-insecure-x!%#ki+nf+4^m03ur$2siiulli+f-g3!^cgcarte&n)as_x9wp'
...
MIDDLEWARE = [
    ...
    'global_config.middleware.BearerTokenMiddleware', 
...
SWAGGER_SETTINGS = {
    "SECURITY_DEFINITIONS": {
        "Bearer": {
            ...
            "name": "Authorization",
            "in": "header",
            "description": "Inserire Access Token:<ACCESS_TOKEN>",
        }
    },
